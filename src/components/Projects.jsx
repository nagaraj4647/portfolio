...
export const projects = [
  ...
  {
    id: 'sri-balaji-website',
    title: 'Sri Balaji Tailoring',
    category: 'Web Apps',
    tagline: 'Professional Tailoring Services Website',
    description: 'A modern, elegant website for a tailoring business to showcase their services, latest designs, and expertise to local customers.',
    tech: ['React', 'Tailwind CSS', 'Vite', 'Framer Motion'],
    liveUrl: 'https://sri-balaji-tailoring-website-five.vercel.app/',
    ...
    badge: 'Freelance',
    highlights: [
      'Showcase of Services and Designs',
  ...
  },
  {
    ...
    title: 'MJ Foods',
    category: 'Web Apps',
    tagline: 'E-commerce WhatsApp Ordering Platform',
    description: 'A modern food ordering platform where users can explore the MJ Foods collection, build their cart, and send confirmed order details directly through WhatsApp.',
    tech: ['React', 'Tailwind CSS', 'Vite', 'E-commerce'],
    liveUrl: 'https://frontend-1xly73ral-nagaraj4647s-projects.vercel.app/',
    ...
    badge: 'E-commerce',
    highlights: [
      'Interactive Product Catalog and Cart',
      'Direct WhatsApp Order Integration',
      'Warm and Easy-to-use Interface',
      'Responsive Design for Mobile Users',
    ],
  },
  {
    id: 'sri-balaji-booking',
    title: 'Tailoring Booking Portal',
    category: 'Full Stack',
    tagline: 'Online Appointment & Booking System',
    description: 'A streamlined booking application for Sri Balaji Tailoring allowing customers to schedule measurement and fitting appointments online.',
    tech: ['React', 'Node.js', 'Express', 'Tailwind CSS'],
    liveUrl: 'https://sri-balaji-tailoring-booking.vercel.app/',
